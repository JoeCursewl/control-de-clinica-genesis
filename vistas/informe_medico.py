...
class Informe_medico(ctk.CTkFrame):
    ...
    def informe_medico_pacientes_window(self):
        ...
        label_divisor = ctk.CTkLabel(frame_top, text="Administración | Informe Médico                                                                                                                                        ", font=self.letra_label_divisor)
    ...
    def generar_constancia_medica(self):
        ...
        if cedula and nombres and apellidos and medico and cedula and especialidad and tratamiento and diagnostico != '':
            if nombres.isdigit():
                ...
                if especialidad.isdigit():
                    ...
                    if apellidos.isdigit():
                        ...
                        if cedula.isdigit():
                            if  nombre_pdf_dir:
                                CTkMessagebox(title="Informes médicos | Generando /",
                                message="Generando informe médico...", 
                                icon="check",
                                option_1="Cerrar",
                                fade_in_duration=35) 
                                pdf = FPDF()
                                ...
                                pdf.cell(0, 25, "Informe Médico", 0, 0, 'C')
                                pdf.ln(40)
