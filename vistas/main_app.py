...
class Main_app(ctk.CTkFrame):
    ...
    def app_window(self):
        ...
        self.app_view.title("Vista General | Administradores")
    ...
    def open_window_actualizar(self):
        self.actualizar_historial.actualizar_window()
    ...
    def open_window_consultar_usuarios(self):
        self.consultar_usuarios.consult_window_usuarios()
        
    def open_window_eliminar(self):
        self.eliminar.delete_window()
    ...
    def open_window_actualizar_pacientes(self):
        self.actualizar_pacientes.actualizar_pacientes_window()
        
    def open_window_eliminar_pacientes(self):
        self.eliminar_pacientes.eliminar_pacientes_window()
    ...
    def open_window_register_usuarios(self):
        self.registrar_usuarios.register_usuarios_window()
        
    def open_window_actualizar_usuarios(self):
        self.actualizar_usuarios.actualizar_usuarios_window()
    
    def open_window_eliminar_usuarios(self):
        self.eliminar_usuarios.eliminar_usuarios_window()
    ...
    def ask_if_close(self):
        info = CTkMessagebox(title="Clínica Génesis | Cerrar",
                             message="¿Está seguro que desea cerrar esta ventana?",
                             icon="info",
                                option_1="Si",
                                option_2="No",
                                fade_in_duration=35)
